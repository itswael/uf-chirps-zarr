...
# Import the Zarr client
import sys
sys.path.append(str(Path(__file__).parent.parent.parent))
from client.zarr_client import ChirpsZarrClient
...
# Initialize Zarr client
zarr_client = ChirpsZarrClient()
...
async def get_timeseries(request: DataRequest):
    ...
    try:
        with zarr_client:
            # Get spatial subset
            data = zarr_client.get_spatial_subset(
